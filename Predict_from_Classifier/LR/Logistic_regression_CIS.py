...
def prepare_train_data(train_data, item_list, item_dict, reversed_item_dict, term_dict_train):
    ...
    # train_df.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/train_df.csv')
    # train_df.to_json('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/train_df.json', orient='records', lines=True)
...
def prepare_test_data(test_data, item_list, item_dict, reversed_item_dict, test_target):
    ...
    for basket in test_target['baskets']:
        ...
        if ls==1221:
            for item in basket:
                if item not in courses_term_1221 and course_CIS_dept_filtering(item)==1:
                    courses_term_1221.append(item)
        if ls==1218:
            for item in basket:
                if item not in courses_term_1218 and course_CIS_dept_filtering(item)==1:
                    courses_term_1218.append(item)
        if ls==1215:
            for item in basket:
                if item not in courses_term_1215 and course_CIS_dept_filtering(item)==1:
    ...
    # train_df.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/test_df.csv')
    # train_df.to_json('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/test_df.json', orient='records', lines=True)
...
def Logistic_regression_main(train_data_en_all, course_track):
     # for course_data in train_data_en_all:
    ...
    for course in course_track.keys():
        ...
        if flag1==1 and flag0==1:
            ...
            list_of_models.append(regr) #prev regr
    # regr.fit(X, y)
...
def evaluate_test_data(test_data_en_all, regr, course_track, course_track2, course_track3, all_courses_en, reversed_item_dict):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/course_en_ac_pr_Logistic_regression_CIS_v10.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/course_en_ac_pr_Logistic_regression_CIS_v10.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/test_course_allocation_v2_CIS.txt"
    ...
    # course_allocation_actual_predicted.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Logistic_regression/test_course_allocation_v2.csv')

...
def evaluate_test_data(test_data_en_all, regr, course_track, course_track2, course_track3, all_courses_en, reversed_item_dict):
    ...
    course_en_ac_pr.to_csv('./course_en_ac_pr_Logistic_regression_CIS_v10.csv')
    course_en_ac_pr.to_json('./course_en_ac_pr_Logistic_regression_CIS_v10.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "./test_course_allocation_v2_CIS.txt"

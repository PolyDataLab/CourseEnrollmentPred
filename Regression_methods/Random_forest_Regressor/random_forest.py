...
# calculate a dictionary where key = semester, value = another dictionary with course and number of actual enrolments
...
# calculate a dictionary where key = semester, value = another dictionary with course and number of predicted enrolments that are relevant (true) to target semesters' course

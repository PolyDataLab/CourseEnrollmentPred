...
def preprocess_train_data_part2(input_data):
    ...
    for user in users:
        ...
        row = [user, b, data.iloc[index]['num_baskets'], data.iloc[index]['last_semester'], data.iloc[index]['timestamps'], data.iloc[index]['grades'][0:] ]
        #row = [user, b, baskets.iloc[index]['num_baskets']]
        train_valid.append(row)
        
    train_set_all = pd.DataFrame(train_valid, columns=['userID', 'baskets', 'num_baskets', 'last_semester', 'timestamps', 'grades'])
    ...
    for user in users:
        ...
        #if baskets.iloc[index]['num_baskets']>=2:
        row = [user, b, data.iloc[index]['num_baskets']-1, data.iloc[index]['last_semester'], data.iloc[index]['timestamps'], data.iloc[index]['grades'][0:-1]]
        #row = [user, b, baskets.iloc[index]['num_baskets']]
        train_valid2.append(row)
        
    train_set_without_target = pd.DataFrame(train_valid2, columns=['userID', 'baskets', 'num_baskets',  'last_semester', 'timestamps', 'grades'])
    ...
    train_set_all.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/train_sample_all.json', orient='records', lines=True)
    train_set_without_target.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/train_set_without_target.json', orient='records', lines=True)
    target_set.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/target_set.json', orient='records', lines=True)
...
def preprocess_valid_data_part2(input_data):
    ...
    for user in users:
        ...
        index += 1
    valid_set_all = pd.DataFrame(valid_all, columns=['userID', 'baskets', 'num_baskets',  'last_semester', 'timestamps', 'grades'])
    valid_2 = []
    index = 0
    for user in users:
        #index = data[data['userID'] == user].index.values[0]
    ...
    valid_set_without_target = pd.DataFrame(valid_2, columns=['userID', 'baskets', 'num_baskets',  'last_semester', 'timestamps', 'grades'])
    ...
    valid_set_all.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/valid_sample_all.json', orient='records', lines=True)
    valid_set_without_target.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/valid_sample_without_target.json', orient='records', lines=True)
    validation_target_set.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/validation_target_set.json', orient='records', lines=True)
...
def preprocess_test_data_part2(input_data):
    ...
    for user in users:
        ...
        if data.iloc[index]['num_baskets']>=3:
            ...
            test_all.append(row)
        index +=1
    test_set_all = pd.DataFrame(test_all, columns=['userID', 'baskets', 'num_baskets', 'last_semester', 'timestamps', 'grades'])
    ...
    test_set_without_target = pd.DataFrame(test_2, columns=['userID', 'baskets', 'num_baskets', 'last_semester', 'timestamps', 'grades'])
    test_target_set = []
    index = 0
    for user in data.userID.values:
        #index = data[data['userID'] == user].index.values[0]
    ...
    test_set_all.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/test_sample_all.json', orient='records', lines=True)
    test_set_without_target.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/test_sample_without_target.json', orient='records', lines=True)
    test_target_set.to_json('/Users/mkhan149/Downloads/Experiments/Others/Random_forest/test_target_set.json', orient='records', lines=True)

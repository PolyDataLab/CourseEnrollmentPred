...
# calculating offered course dict for every semesters from all the data
...
if __name__ == '__main__':
    ...
    offered_course_dict = offered_course_cal('/Users/mkhan149/Downloads/Experiments/all_data.json')

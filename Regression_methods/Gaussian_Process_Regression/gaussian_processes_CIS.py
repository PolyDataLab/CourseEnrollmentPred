...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/test_data_en_all_CIS.csv')
    test_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/test_data_en_all_CIS.json', orient='records', lines=True)
...
def evaluate_test_data(test_data_en_all, regr):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/course_en_ac_pr_CIS_v5.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/course_en_ac_pr_CIS_v5.json', orient='records', lines=True)

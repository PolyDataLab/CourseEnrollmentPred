...
#calculating dictionary where key = semester and values = another dictionary with course and number of actual enrollments
...
def prepare_train_data(train_data, train_courses, avg_enrollment_train, reversed_item_dict):
    ...
    train_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/train_data_en_all.csv')
    train_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/train_data_en_all.json', orient='records', lines=True)
...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/test_data_en_all.csv')
    test_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/test_data_en_all.json', orient='records', lines=True)
...
def evaluate_test_data(test_data_en_all, regr):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/course_en_ac_pr_v5.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/course_en_ac_pr_v5.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "/Users/mkhan149/Downloads/Experiments/Others/Gaussian_processes/test_course_allocation_v5.txt"
...
#    avg_enrollment_train = pd.read_json('/Users/mkhan149/Downloads/Experiments/avg_enrollment_prior_term.json', orient='records', lines= True)
   ...
   # function call for GPR algorithm 

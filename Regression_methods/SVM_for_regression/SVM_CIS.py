...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/test_data_en_all_CIS.csv')
    test_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/SVM/test_data_en_all_CIS.json', orient='records', lines=True)
    return test_data_en_all1

def SVM_main(train_data_en_all):
    X = train_data_en_all.iloc[:, 0:-1]
    y = train_data_en_all.iloc[:, -1]
    regr = regr = make_pipeline(StandardScaler(), SVR(C=1.0, epsilon=0.2))
    regr.fit(X, y)
    return regr
...
def evaluate_test_data(test_data_en_all, regr):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/course_en_ac_pr_CIS.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/SVM/course_en_ac_pr_CIS.json', orient='records', lines=True)

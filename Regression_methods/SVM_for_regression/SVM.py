...
def evaluate_test_data(test_data_en_all, regr):
    ...
    course_en_ac_pr.to_csv('./course_en_ac_pr_SVM.csv')
    course_en_ac_pr.to_json('./course_en_ac_pr_SVM.json', orient='records', lines=True)
...
#     train, test, valid = split_data('./Others/SVM_2/train_sample.csv')

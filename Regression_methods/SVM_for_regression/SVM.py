...
# calculating dictionary where key = semester, value = another dictionary with courses and number of actual enrollments
...
#calculate frequency of courses over semesters
...
# calculate standard deviation for errors
...
def prepare_train_data(train_data, train_courses, avg_enrollment_train, reversed_item_dict):
    ...
    train_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/train_data_en_all.csv')
    train_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/SVM/train_data_en_all.json', orient='records', lines=True)
...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/test_data_en_all.csv')
    test_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/SVM/test_data_en_all.json', orient='records', lines=True)
    return test_data_en_all1

# SVM for regression algorithm
def SVM_main(train_data_en_all):
...
def evaluate_test_data(test_data_en_all, regr):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/course_en_ac_pr_SVM.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/SVM/course_en_ac_pr_SVM.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "/Users/mkhan149/Downloads/Experiments/Others/SVM/test_course_allocation_v2.txt"
    ...
    # course_allocation_actual_predicted.to_csv('/Users/mkhan149/Downloads/Experiments/Others/SVM/test_course_allocation_v2.csv')
...
#     train, test, valid = split_data('/Users/mkhan149/Downloads/Experiments/Others/SVM_2/train_sample.csv')
...
#    avg_enrollment_train = pd.read_json('/Users/mkhan149/Downloads/Experiments/avg_enrollment_prior_term.json', orient='records', lines= True)
   ...
   #call SVM for regression
   regr = SVM_main(train_data_en_all)

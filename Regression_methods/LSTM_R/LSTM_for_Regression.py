...
def prepare_train_data(train_data, train_courses, avg_enrollment_train, reversed_item_dict):
    ...
    train_data_en_all1.to_csv('./train_data_en_all2.csv')
    train_data_en_all1.to_json('./train_data_en_all2.json', orient='records', lines=True)
...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('./test_data_en_all2_LSTM_R_v5.csv')
    test_data_en_all1.to_json('./test_data_en_all2_LSTM_R_v5.json', orient='records', lines=True)
...
def evaluate_test_data_new(test_x, test_y, regr):
    ...
    course_en_ac_pr.to_csv('./course_en_ac_pr_2_LSTM.csv')
    course_en_ac_pr.to_json('./course_en_ac_pr_2.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "./test_course_allocation_LSTM_R_v5.txt"
...
#     train, test, valid = split_data('./Others/LSTM_R_2/train_sample.csv')

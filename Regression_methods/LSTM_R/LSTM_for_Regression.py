...
#calculating term dictionary where key = semester and value = another dictionary with course and number of true predictions
...
#calculating term dictionary where key = semester and value = another dictionary with course and number of false predictions
...
# calculate frequency of courses, average and standard deviation of number of enrollments in each course over all semesters
...
# prepare data for course enrollment prediction task
...
def prepare_test_data(test_target, all_courses, avg_enrollment_all, term_dict_test):
    ...
    test_data_en_all1.to_csv('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/test_data_en_all2_LSTM_R_v5.csv')
    test_data_en_all1.to_json('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/test_data_en_all2_LSTM_R_v5.json', orient='records', lines=True)
...
def evaluate_test_data_new(test_x, test_y, regr):
    ...
    course_en_ac_pr.to_csv('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/course_en_ac_pr_2_LSTM.csv')
    course_en_ac_pr.to_json('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/course_en_ac_pr_2.json', orient='records', lines=True)
...
def calculate_mse_for_course_allocation(actual_en, en_pred):
    ...
    #count1= 0
    count2 = 0
    output_path1=  "/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/test_course_allocation_LSTM_R_v5.txt"
    ...
    # course_allocation_actual_predicted.to_csv('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R/test_course_allocation_v2.csv')
...
#     train, test, valid = split_data('/Users/mkhan149/Downloads/Experiments/Others/LSTM_R_2/train_sample.csv')
...
#    regr = Gaussian_processes_main(train_data_en_all)
   ...
   # call LSTM for regression model
